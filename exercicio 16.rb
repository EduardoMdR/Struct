...
def combinacao(letra)               # a função imprime os resultados desejados     
    if letra == "A"
        puts "[A, T]"
    elsif letra == "T"
        puts "[T, A]"
...
Como não vou salvar os dados eu posso apenas imprimir os pares de acordo com a fita principal gerada
